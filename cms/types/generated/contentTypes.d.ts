...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ContactDetails: Schema.Attribute.Relation<
      'manyToMany',
      'api::contact-info.contact-info'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    Insertion: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    PrimaryContact: Schema.Attribute.Relation<
      'oneToOne',
      'api::contact-info.contact-info'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiDiscountCodeDiscountCode
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    TimesValid: Schema.Attribute.Integer &
      Schema.Attribute.Required &
    ...
    TotalDiscountPercentage: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
...
export interface ApiEventDateTimeEventDateTime
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::event-date-time.event-date-time'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DatesAndTimes: Schema.Attribute.Relation<
      'oneToMany',
      'api::event-date-time.event-date-time'
    >;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    EventDateTime: Schema.Attribute.Relation<
      'oneToOne',
      'api::event-date-time.event-date-time'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    PickedUp: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
